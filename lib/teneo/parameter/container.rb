    ...
    module Container
      ...
      module ClassMethods
        ...
        def parameter(**options)
          ...
          param = (self.parameter_defs[name] ||= Teneo::Parameter::Definition.new(name, default: default))
      ...
      def parameter(name, value = NO_VALUE)
        ...
        raise Teneo::Parameter::FrozenError, "Parameter '#{param_def[:name]}' is frozen in '#{self.class.name}'" if param_def[:frozen]
      ...
      rescue Teneo::Parameter::FrozenError
        # ignored
      end
